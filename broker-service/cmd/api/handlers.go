...
//MailPayload是嵌入式类型(在RequestPayload中)，它描述要发送的电子邮件消息
...
// LogEventViaRabbit使用记录器服务记录事件。它通过将数据推送到RabbitMQ来进行调用
...
// LogItemViaRPC通过对logger微服务进行RPC调用来记录项目
